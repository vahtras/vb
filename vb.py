...
if __name__ == "__main__":
   ...
   #
   if 1:
      #  (sigma_g|sigma_g) = (sa|sa)+(sb|sb) + (sa|sb) + (sb|sa)
      #                    = ionic + covalent
      #
      # Initialize VB orbitals as unit
      #
      ...
      nod.C=full.unit(nb)
      #
      #Initialize a set of determinants
      #
      D=[]
      D.append(nod([0],[0]))
      D.append(nod([1],[1]))
      ...
      #
      #
      #Structures as list of determinants
      #
      is2=math.sqrt(0.5)
      Sion=structure(D[0:2],[is2,is2])
      #
      Scov=structure(D[2:4],[is2,is2])
      #
      # State as a list of structures
      #
      GS=wavefunction([Sion,Scov],[is2,is2],frozen=[0,1])
      print "Ground state",GS
      ion=0; cov=1
      det1=0; det2=1
      a=0; b=1
      print "Ioinic",GS.structs[ion]
      print "Covalent",GS.structs[cov]
      #print "Ioinic first det",GS.structs[ion].nods[det1]
      #print "Ioinic first det a-string",GS.structs[ion].nods[det1](a)
      #print "Ioinic first det a-orbitals",GS.structs[ion].nods[det1].orbitals()[a]
      #print "Ioinic first det b-string",GS.structs[ion].nods[det1](b)
      #print "Ioinic first det b-orbitals",GS.structs[ion].nods[det1].orbitals()[b]

      print "Ground state energy",GS.energy() + GS.Z
      sg,og=GS.energygrad()
      print "Ground state energy gradient",sg,og
      sh,mh,oh=GS.energyhess()
      print "Ground state energy hessian",sh,mh,oh
      #ms,mm,mo=GS.vb_metric()
      #print "VB_metric",ms,mm,mo
